...
export const services = [
  {
    ...
    title: "Боты",
    description:
      "Telegram или WhatsApp. Кастомная разработка: кнопки, меню, сценарии для типовых задач вроде приема заказов, уведомлений, FAQ, рассылок и сбора заявок.",
    price: "от 150 000 ₸",
  ...
  },
  {
    ...
    title: "ИИ-агенты",
    description:
      "Кастомный ИИ-агент под вашу задачу: память, контекст, интеграции с CRM, базами и внешними API. Заточен под нишу: поддержка клиентов, продажи, SEO, юр-консультации, любая узкая экспертиза.",
    price: "от 600 000 ₸",
  ...
  },
  {
    ...
    title: "ИИ-сайты",
    description:
      "Сайт с нуля с одной встроенной ИИ-функцией. Лендинг, корпоративный, каталог, промо-сайт или другой формат на ваш выбор. В каждый сайт входит базовая SEO- и GEO-разметка. Варианты функции: ИИ-чат-консультант на ваших услугах или ИИ-калькулятор стоимости, конкретный сценарий обсудим под вашу задачу.",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
      ...
      <Container>
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-accent/30 bg-card/40 p-8 text-center md:p-10">
          ...
          <p className="max-w-xl text-muted">
            Опишите ее обычным текстом, и ИИ-калькулятор посчитает стоимость и
