...
export const services = [
  ...
  },
  {
    ...
    title: "Автоматизации",
    description:
      "Свяжу ваши сервисы и рабочие процессы в единый поток без вашего участия. Использую Make — для типовых задач, кастомные решения — для нестандартных сценариев.",
    price: "от 350 000 ₸",
    duration: "до 1 недели",
  },
  {
