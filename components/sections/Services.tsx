...
export const services = [
  ...
  },
  {
    ...
    title: "Автоматизации",
    description:
      "Перестаньте копировать данные из одной системы в другую. Заявки с сайта сами приходят в вашу CRM, клиенту автоматически ответ в WhatsApp, менеджеру создается задача. Подключаю Bitrix24, amoCRM, 1С, Kaspi и другие системы — все работает в одном потоке, без вашего участия.",
    price: "от 500 000 ₸",
  ...
  },
  {
    ...
    description:
      "Рабочий прототип на iOS и Android из одного кода на Flutter. Минимальный дизайн, авторизация, база данных, сборка APK для теста. Публикацию в App Store / Google Play делаете самостоятельно или через специализированного подрядчика — это не наша услуга.",
    price: "от 2 000 000 ₸",
    duration: "до 2 недель",
  },
];
