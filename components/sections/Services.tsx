...
export const services = [
  ...
  },
  {
    ...
    title: "AI-сайты",
    description:
      "Сайт с нуля с одной встроенной AI-функцией. Лендинг, корпоративный, каталог, промо-сайт или другой формат — на ваш выбор. Варианты: AI-чат-консультант на ваших услугах; AI-калькулятор стоимости; AI-анализ для клиента (проверка сайта, разбор договора, чек-лист).",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
