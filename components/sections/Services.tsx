...
export const services = [
  ...
  },
  {
    ...
    title: "AI-сайты",
    description:
      "Делаю сайт с нуля и встраиваю одну AI-функцию. Лендинг или корпоративный — на выбор. Варианты функции: чат-консультант, который знает ваши услуги; AI-калькулятор стоимости; мини-аудит для сбора лидов; умный поиск по каталогу. Сайт, который продает, а не просто красивая обложка.",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
