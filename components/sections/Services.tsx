...
export const services = [
  {
    ...
    description:
      "Telegram, WhatsApp. От простого бота с кнопками до умного ассистента с AI, памятью и интеграциями. Под вашу задачу — консультант, прием заказов, поддержка, персональный помощник.",
    price: "от 300 000 ₸",
