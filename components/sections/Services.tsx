...
export const services = [
  ...
  },
  {
    ...
    title: "AI-сайты",
    description:
      "Сайт с нуля с одной встроенной AI-функцией. Лендинг, корпоративный, каталог, промо-сайт или другой формат — на ваш выбор. Варианты: AI-чат-консультант, который знает ваши услуги; AI-калькулятор стоимости; AI-помощник подбора («тур до 500к под Бали с детьми»). Сайт, который продает, а не просто красивая обложка.",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
