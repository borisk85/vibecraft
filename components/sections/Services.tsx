...
export const services = [
  ...
  },
  {
    ...
    title: "AI-сайты",
    description:
      "Сайт с нуля с одной встроенной AI-функцией. Лендинг, корпоративный, каталог, промо-сайт или другой формат — на ваш выбор. Варианты функции: AI-чат-консультант на ваших услугах или ИИ-калькулятор стоимости — конкретный сценарий обсудим под вашу задачу.",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
