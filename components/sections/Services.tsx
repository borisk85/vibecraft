...
export const services = [
  ...
  },
  {
    ...
    title: "Автоматизации",
    description:
      "Бизнес-сценарии с production-надежностью. Триггеры из лендинга, CRM, мессенджеров → multi-step цепочки в Make или кастомный backend через Claude Code. Интеграции с Bitrix24, amoCRM, 1С, Kaspi и другими системами без готовых коннекторов.",
    price: "от 500 000 ₸",
