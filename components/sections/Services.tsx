...
export const services = [
  {
    ...
    title: "Боты",
    description:
      "Telegram или WhatsApp. Кастомная разработка: кнопки, меню, сценарии для типовых задач — прием заказов, уведомления, FAQ, рассылки, сбор заявок.",
    price: "от 150 000 ₸",
      ...
      <Container>
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-accent/30 bg-card/40 p-8 text-center md:p-10">
          ...
          <p className="max-w-xl text-muted">
            Опишите ее обычным текстом — ИИ-калькулятор посчитает стоимость и
