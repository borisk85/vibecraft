...
export const services = [
  ...
  },
  {
    ...
    title: "Автоматизации",
    description:
      "Связка нескольких сервисов в один поток без ручной работы. Типовые задачи: заявки с сайта в CRM, синхронизация заказов в 1С, обработка платежей, рассылки, напоминания клиентам, отчеты владельцу. Подключение к Bitrix24, amoCRM, 1С, Kaspi и другим сервисам.",
    price: "от 500 000 ₸",
  ...
  },
  {
    ...
    description:
      "Рабочий прототип на iOS и Android из одного кода на Flutter. Минимальный дизайн, авторизация, база данных, сборка APK для теста. Публикации в App Store / Google Play не входят в стоимость и не предоставляются как отдельная услуга.",
    price: "от 2 000 000 ₸",
    duration: "до 2 недель",
  },
];
