...
export const services = [
  ...
  },
  {
    ...
    title: "ИИ-сайты",
    description:
      "Сайт с нуля с одной встроенной ИИ-функцией. Лендинг, корпоративный, каталог, промо-сайт или другой формат — на ваш выбор. Варианты функции: ИИ-чат-консультант на ваших услугах или ИИ-калькулятор стоимости — конкретный сценарий обсудим под вашу задачу.",
    price: "от 800 000 ₸",
    duration: "до 2 недель",
  },
  {
