...
const steps = [
  ...
  {
    step: "02",
    title: "Провожу бриф на 15-30 минут",
    description:
      "Разбираю задачу: контекст, пути реализации, нужный результат. Предлагаю стек, сроки и стоимость.",
  },
  {
    step: "03",
    title: "Собираю первую рабочую версию",
    description:
      "Бот, сценарий автоматизации или прототип MVP — то, что вы можете протестировать в деле. Видите результат до финальной полировки.",
  },
  {
    step: "04",
    title: "Разрабатываю с демо по запросу",
    description:
      "Показываю прогресс по вашему запросу в любой момент. Правки вносятся в процессе, а не в финале — это экономит недели.",
  },
  {
    step: "05",
    ...
    <MotionSection id="process" className="relative py-24 md:py-28">
      <Container>
        <SectionHeading
          ...
          description="Прозрачные этапы, регулярные демо и поэтапная оплата. Вы видите прогресс и управляете тонкостями разработки до конечного продукта."
        />
