...
const steps = [
  ...
  },
  {
    ...
    description:
      "Готовый бот, ИИ-агент, ИИ-сайт или автоматизация, либо кликабельный прототип MVP. Показываю прогресс по вашему запросу, не чаще одного раза в 3-5 дней. Правки вносятся вами сразу, а не в конце.",
  },
  {
    step: "03",
    title: "Сдаю и поддерживаю",
    description:
      "Передаю вам готовый продукт, доступы и документацию. 14 дней бесплатных правок после сдачи. Дальше, если потребуется, на ваш выбор: поддержка по пакету или почасово.",
  },
];
