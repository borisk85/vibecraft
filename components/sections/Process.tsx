...
const steps = [
  ...
  {
    step: "03",
    title: "Сдаю продукт и поддерживаю",
    description:
      "Передаю вам готовый продукт, доступы и документацию. 14 дней бесплатных правок после сдачи. Далее, если потребуется на ваш выбор — поддержка по тарифу или почасово.",
  },
];
