...
const steps = [
  {
    ...
    description:
      "Вы пишете мне в Telegram или через форму. Отвечаю в течение рабочего дня, в пределах 1–2 часов. Разбираем задачу: контекст, пути реализации, нужный результат. Предлагаю стек, сроки и стоимость.",
  },
  {
    step: "02",
    title: "Собираю продукт и показываю демо",
    description:
      "Готовый бот, AI-ассистент или автоматизация, либо кликабельный прототип MVP. Показываю прогресс по вашему запросу — не чаще одного раза в 3-5 дней. Правки вносятся сразу, а не в конце.",
  },
  {
    step: "03",
    title: "Сдаю продукт",
