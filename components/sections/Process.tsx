...
const steps = [
  ...
  },
  {
    ...
    description:
      "Готовый бот, AI-агент или автоматизация, либо кликабельный прототип MVP. Показываю прогресс по вашему запросу — не чаще одного раза в 3-5 дней. Правки вносятся сразу, а не в конце.",
  },
  {
    step: "03",
    title: "Сдаю продукт",
