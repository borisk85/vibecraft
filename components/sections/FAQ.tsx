...
export const faqs: Faq[] = [
  {
    ...
    a: "Скорость — за счет Claude: берет на себя boilerplate, тесты, типизацию, CRUD-обвязку. Архитектуру, безопасность и бизнес-логику пишу и проверяю сам. Код уходит в продакшн, а не в демо.",
  },
  {
    q: "Как принимаете оплату?",
    a: "Kaspi Gold по номеру телефона — для частных клиентов. ТОО и компаниям со счетом, актом и ЭСФ — через ИП на упрощенке. 50% предоплата перед стартом, 50% после демо. Для крупных проектов (от 1 500 000 ₸) возможно 30/40/30 по этапам.",
  },
  {
    q: "Что если в процессе нужны правки?",
    a: "Правки в рамках изначального ТЗ — бесплатно. Если меняется объем (новые экраны, новая логика) — пересчитываю. Демо — по вашему запросу в любой момент, чтобы правки ловились в процессе, а не после сдачи.",
  },
  {
    q: "Есть ли гарантия после сдачи?",
    a: "14 дней бесплатных правок после сдачи — баги и мелкие правки по ТЗ. Дальше — по прайсу апсейлов или контракту поддержки.",
  },
  {
  ...
  },
  {
    ...
    a: "Да. Работаю через ИП на упрощенке — оформлю при первом запросе от ТОО-клиента. Счет, акт, ЭСФ через esf.gov.kz — все официально.",
  },
  {
