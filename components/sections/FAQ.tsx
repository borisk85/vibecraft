...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    a: "Да. Месячная подписка без обязательств: Базовый — до 5 часов за 90 000 ₸/мес, Расширенный — до 15 часов за 240 000 ₸/мес. Продлеваете помесячно, можете закрыть в любой момент. Или почасово без подписки — 25 000 ₸/час. Новые функции, экраны, интеграции — это уже отдельная разработка по новой смете, не поддержка.",
  },
  {
