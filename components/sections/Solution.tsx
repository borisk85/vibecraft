...
const points = [
  {
    icon: Gauge,
    title: "У AI скорость и качество, у меня решения и управление",
    description:
      "Claude Code берет на себя всю рутину и архитектуру. Безопасность, функционал и бизнес-логику проверяю и собираю я.",
  },
  {
    icon: Puzzle,
  ...
  },
  {
    ...
    description:
      "Регулярные демо. Вы видите работающий продукт уже на старте, а не в конце. Оплата поэтапно, никаких вложений вслепую без результатов.",
  },
];
    ...
    <MotionSection id="solution" className="py-24 md:py-28">
      <Container>
        <SectionHeading
          eyebrow="Подход"
          title="Как я работаю"
          description="Максимум сосредоточения на каждой задаче. Быстрый и понятный процесс от начала и до конечного продукта, без исчезновений, удлинения сроков и завышения стоимости."
        />
