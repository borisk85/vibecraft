...
const cases = [
  ...
  },
  {
    ...
    title: "Дуэт — AI-сомелье для подбора напитков",
    description:
      "Мобильное приложение с AI-рекомендациями напитков к блюдам. Streaming-ответы Claude, персонализация по региону и предпочтениям, подписочная модель через RevenueCat.",
    stack: [
      "Flutter",
      "Dart",
      "FastAPI",
