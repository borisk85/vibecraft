        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[320px_1fr] lg:gap-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 text-muted leading-relaxed md:text-lg">
              <p>
                Меня зовут Борис. Я AI-фаундер из Алматы. Vibecraft — это
                один разработчик + AI-инструменты вместо классической студии.
                Строю продукты на Claude Code: от Telegram-ботов до SaaS и
                мобильных приложений. За последний год собрал и запустил
                собственный SaaS (velabot.io), мобильное приложение Duet
                и несколько автоматизаций для внутренних процессов.
                Результат и сроки контролирую лично. Если что-то обещаю —
                делаю.
              </p>
            </div>
