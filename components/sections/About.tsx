        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[320px_1fr] lg:gap-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 text-muted leading-relaxed md:text-lg">
              <p>
                AI-фаундер из Алматы, 7+ лет в IT. Последние 2 года строю
                продукты на AI-стеке: веду собственный SaaS для Telegram-ботов
                и параллельно запускаю клиентские проекты. Claude Code и
                Cursor делают рутину, архитектуру, безопасность и результат
                контролирую лично. Если что-то обещаю — делаю.
              </p>
            </div>
