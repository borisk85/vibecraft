...
const pains = [
  ...
  {
    icon: EyeOff,
    title: "Фрилансер исчез с 300 000 ₸ предоплаты",
    description:
      "Одиночка без обязательств — лотерея. Сегодня отвечает, завтра «заболел», через месяц молчание и заблокированный аккаунт.",
  },
  {
    icon: PackageX,
    title: "Коробка дает 70% функций и 0% гибкости",
    description:
      "Шаблонные платформы закрывают базу, но ломаются там, где нужна ваша логика: Kaspi Pay, связка с 1С, нестандартный воркфлоу.",
  },
  {
    icon: Clock,
