    ...
    <MotionSection className="py-24 md:py-28">
      <Container>
        <SectionHeading
          ...
          description="Максимум сосредоточения вместо бюрократии у студии разработки. Прозрачный и быстрый процесс от задачи до запуска, без исчезновений, удлинения сроков и шаблонных решений."
        />
