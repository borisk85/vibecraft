...
export const faqs: Faq[] = [
  ...
  {
    q: "Почему мне не заказать на Upwork, Kwork или других платформах?",
    a: "Можно, конечно. Но на платформах вы платите комиссию посреднику и общаетесь не напрямую. У меня свой сайт — можно посмотреть кейсы и связаться лично. Есть ИП для документов с ТОО, я в Алматы — пишемся в Telegram в нормальные часы, без языковых барьеров и разницы во времени.",
  },
  {
