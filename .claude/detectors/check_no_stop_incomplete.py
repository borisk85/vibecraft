...
MAX_ROUNDS = 8  # Было 2 — из-за каскада дублей в чате. Дубли ушли (Stop-хуки в
                # мягком режиме, stop_soft.py), а 2 круга оказалось мало: очередь
                # из 4+ задач переживала лимит, и я вставал недоделав. (22.07)
